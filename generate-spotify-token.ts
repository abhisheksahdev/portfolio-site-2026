...
console.log(
  "1. Created a Spotify app at https://developer.spotify.com/dashboard",
);
console.log(
  "2. Added http://localhost:3001/callback to your app's redirect URIs",
);
console.log("3. Set your SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET in .env");
console.log();
console.log("🔍 Current configuration:");
console.log(
  `   Client ID: ${CLIENT_ID ? CLIENT_ID.substring(0, 8) + "..." : "NOT SET"}`,
);
console.log(`   Redirect URI: ${REDIRECT_URI}`);
console.log();
console.log(
  "⚠️  IMPORTANT: The redirect URI in your Spotify app MUST EXACTLY match:",
);
